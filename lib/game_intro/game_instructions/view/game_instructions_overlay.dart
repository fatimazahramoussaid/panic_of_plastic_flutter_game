  ...
  List<GameInstruction> get instructions {
    ...
    return [
      ...
      if (isDesktop)
        ...
        GameInstruction(
          title: l10n.gameInstructionsPageMoveBotTitle,
          description: l10n.gameInstructionsPageMoveBotTitleDescription,
          assetPath: Assets.images.tapToJumpInstruction.path,
        ),
      if (isDesktop)
        GameInstruction(
          title: l10n.gameInstructionsPageMoveBotTitleDesctop,
          description: l10n.gameInstructionsPageMoveBotTitleDesctopDescription,
          assetPath: Assets.images.tapNavBar.path,
        )
      else
        GameInstruction(
          title: l10n.gameInstructionsPageMoveBotTitle,
      ...
      GameInstruction(
        ...
        assetPath: Assets.images.avoidBlackHole.path,
      ),
    ];
  }
